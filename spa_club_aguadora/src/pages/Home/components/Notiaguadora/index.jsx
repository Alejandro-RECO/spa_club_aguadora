...
export const Notiaguadora = () => {
   return (
      <section className="px-3 md:px-14 py-16 bg-secondary flex flex-col gap-5">
         ...
         <article className="containe text-primary-900 py-2 shadow-lg flex flex-col md:flex-row justify-center items-center md:mx-16 p-5 gap-5">
            <Img
               size={"l"}
               shape={"rounded"}
            ...
            <div className="flex flex-col items-end py-5 font-serif">
               ...
               <q>{MEDIA_PATHS.HOME.NOTIAGUADORA_ED_2.CONTENT_2.PRESIDENT}</q>
